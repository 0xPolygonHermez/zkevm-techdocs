...
\newcommand{\pparams}{\ensuremath{\textsf{pp}}\xspace}
\newcommand{\vparams}{\ensuremath{\textsf{vp}}\xspace}
...
\newcommand{\eQ}{\ensuremath{\epsilon_{\textsf{Q}}}\xspace}
\newcommand{\eInc}{\ensuremath{\epsilon_{\textsf{Inc}}}\xspace}
...
\newenvironment{proofs}{\textit{Proof Sketch.}}{\hfill$\blacksquare$}
...
\input{../latex/techniques.tex}
\input{../latex/protocol.tex}
...
\input{../latex/full-protocol-descriptions.tex}

\newpage
\input{../latex/code-equivalences.tex}
