...
%TODO: Preprocessing phase!?
%TODO: Improve this section, I do not like it
%TODO: talk about the "theoretical" version with oracle when it is done and add a draw about this phase
...
Our IOP for eAIR, which can be seen as an extension of the DEEP-ALI protocol \cite{EPRINT:BGKS19}, is a follows.
...
\begin{proof}[Proof of Theorem \ref{thm:STIK}]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Full Protocol Description}
...
%TODO: ADd parameters and make the diagrams non-interactive
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
